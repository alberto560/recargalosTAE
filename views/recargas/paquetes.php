...
<html lang="en">
  <head>
    ...
    <script type="text/javascript" src="assets/js/js_views/js_paquetes.js"></script>
    <!-- Bootstrap tooltips -->
  ...
  <body></br>
  <center>
  <div class="contenedor-resp rad">
      <div class="row">
        <div class="col-md-12" data-step="2" data-intro="Vista Reportes">
          <div class="accordion" id="accordionExample" data-step="2" data-intro="Vista de categoria paquetes<br/> telcel">
            <div class="card-resp" style="border-radius: 32px 32px 32px 32px;">
              <div class="card-header heading" id="headingOne" data-step="3" data-intro="Paquetes Amigo sin limite" style="border-radius: 32px 32px 32px 32px;">
                  ...
                  <div class="container-flex mt-2">
                    <div class="main-tabs-docs">
                      <div class="tab-content">
                        <section>
                          <div class="row my-4 flex-center">
                            <div class="col-11 card-group">
                              <div class="card" style="border-radius: 10px 10px 10px 10px">
                                <!-- Card image -->
                                <div class="view overlay zoom tel" data-step="4" data-intro="Seleccionar paquete Amigo sin limite <img src='ayuda/sites/statics/css/images/img/ayu-paq.png' height='320' />">
                                  <img class="card-img-top tel" src="ayuda\sites\statics\css\images\SL020.jpg" alt="Card image cap">
                                  <div class="mask flex-center rgba-blue-strong tel">
                                    <a id="paq20" data-toggle="modal" data-target="#modalPaquetes" data-whatever="@mdo"  class="mask rgba-white-slight"></a>
                                  </div>
                                </div>
                              </div>
                              <p>&emsp;&emsp;</p>
                              <div class="card" style="border-radius: 10px 10px 10px 10px">
                                <div class="view overlay zoom tel">
                                  <img src="ayuda\sites\statics\css\images\SL030.jpg" class="card-img-top" alt="Responsive image">
                                  <a id="paq30" data-toggle="modal" data-target="#modalPaquetes" data-whatever="@mdo"  class="mask rgba-white-slight"></a>
                                </div>
                              </div>
                              <p>&emsp;&emsp;</p>
                              <div class="card" style="border-radius: 10px 10px 10px 10px">
                                <div class="view overlay zoom tel">
                                  <img src="ayuda\sites\statics\css\images\SL050.jpg" class="card-img-top" alt="Responsive image">
                                  <a id="paq50" data-toggle="modal" data-target="#modalPaquetes" data-whatever="@mdo"  class="mask rgba-white-slight"></a>
                                </div>
                              </div>
                              <p>&emsp;&emsp;</p>
                            </div>
                          ...
                          <div class="row my-4 flex-center">
                            <div class="col-11 card-group">
                              <div class="card" style="border-radius: 10px 10px 10px 10px">
                                <div class="view overlay zoom rad">
                                  <img class="card-img-top" src="ayuda\sites\statics\css\images\SL080.jpg" alt="Card image cap">
                                  <a id="paq80" data-toggle="modal" data-target="#modalPaquetes" data-whatever="@mdo"  class="mask rgba-white-slight"></a>
                                </div>
                              </div>
                              <p>&emsp;&emsp;</p>
                              <div class="card" style="border-radius: 10px 10px 10px 10px">
                                <div class="view overlay zoom tel">
                                  <img src="ayuda\sites\statics\css\images\SL100.jpg" class="card-img-top" alt="Responsive image">
                                  <a id="paq100" data-toggle="modal" data-target="#modalPaquetes" data-whatever="@mdo"  class="mask rgba-white-slight"></a>
                                </div>
                              </div>
                              <p>&emsp;&emsp;</p>
                              <div class="card" style="border-radius: 10px 10px 10px 10px">
                                <div class="view overlay zoom tel">
                                  <img src="ayuda\sites\statics\css\images\SL150.jpg" class="card-img-top" alt="Responsive image">
                                  <a id="paq150" data-toggle="modal" data-target="#modalPaquetes" data-whatever="@mdo"  class="mask rgba-white-slight"></a>
                                </div>
                              </div>
                              <p>&emsp;&emsp;</p>
                            </div>
            ...
            <div class="card-resp" style="border-radius: 32px 32px 32px 32px;">
              <div class="card-header heading" id="headingTwo" data-step="5" data-intro="Seleccionar paquete Internet telcel" style="border-radius: 32px 32px 32px 32px;">
                <div class="col-md-12 text-center">
                    <h2 class="mb-0">
    ...
    <!------------------Modal Proceso de Recarga-------------------------------->
      ...
      <div class="modal fade" id="modalConfPagoRecarga" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" style="max-height: 800px;overflow-y: auto;">
        <div class="modal-dialog" role="document">
          <div class="modal-content">
            <div class="modal-header blue-gradient" >
              <h3 class="col-12 modal-title text-center font-weight-bold text-white" id="exampleModalLongTitle"><b>CONFIRMACIÓN DE RECARGA</b></h3>
            </div>
              ...
              <!--div class="row-justify-content-center"-->
                <!--div class="col-12 col-md-12"-->
                  <center>
                    ...
                    <h1><b><label id="lblnumero"></label></b></h1>
                    <h5><em><b>POR LA CANTIDAD DE:</b></em></h5>
                    <h1>$<label id="lblmonto2"></label></h1>
